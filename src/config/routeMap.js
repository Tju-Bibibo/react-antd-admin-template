...
const ScoreTable = Loadable({loader: () => import(/*webpackChunkName:'ScoreTable'*/'@/views/score_table'),loading: Loading});
...
export default [
  ...
  { path: "/score_table", component: ScoreTable, roles: ["admin","editor"] },
];
